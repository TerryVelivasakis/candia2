<h6><Center>SUITE AND MAILBOX KEY RECEIPT</center></h6>
<div class="row">
<div class="col"></div>

<div class="col-3">
<table class="table table-sm table-bordered lease">
  <tr><td>Suite Number<td><?php echo $suiteNumber?>
    <tr><td>Mailbox Number<td><?php echo $suiteMailBox?>
    </table>
</div>
...
<p>
<b>All keys must be returned to management at the end of your lease. Unreturned keys are subject to suite re-key Fee</b></p>
<br>
<?php require $_SERVER["DOCUMENT_ROOT"].'/leasing/executiveLease/signatureBlock.php'; ?>
