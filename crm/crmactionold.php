  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="btn" class="close" data-dismiss="modal" aria-label="Close" onclick='$("#callModal").hide()'>
...
<div class="table-responsive-sm" >
  ...
  <tbody>
    <tr>
      <td><center><button class="txtbtn" onclick="showcallmodal(7)"><i class="fas fa-phone fa-lg"></i></button></td></button></td>
...
if ($show){
echo '<tr'.$trcolor.'  data-id="'.$row['ID'].'">';
